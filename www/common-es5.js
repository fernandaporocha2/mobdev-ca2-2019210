  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "getCharactersWithPagination",
        value: function getCharactersWithPagination(offset) {
          return this.http.get("https://breakingbadapi.com/api/characters?limit=".concat(10, "&offset=", offset));
        ...
        value: function getQuotes() {
          ...
          this.http.get('https://breakingbadapi.com/api/quotes').subscribe(function (data) {
            ...
            console.log("quotes" + _this.allQuotes);
          });
        ...
        key: "getQuoteByAuthor",
        value: function getQuoteByAuthor(author) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              console.log("getQuoteByAuthor " + quote); //transform the compared texts in lower case and verify if the author of the current quote
              //contains the inputed author string

              if (quote.author.toLowerCase().includes(author.toLowerCase())) {
                console.log("found " + quote.author); //If it contains, the current quote will be added to the selectedQuotes
          ...
          console.log(JSON.stringify(selectedQuotes)); //https://stackoverflow.com/questions/35527500/angular2-convert-array-to-observable
        ...
        key: "getDeathCount",
        value: function getDeathCount(responsible) {
          return this.http.get("https://breakingbadapi.com/api/death-count?name=".concat(responsible));
        }
      }]);
