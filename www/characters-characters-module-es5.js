...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["characters-characters-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppPagesCharactersCharactersPageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-header>\n\t<!-- Toolbar theme -->\n\t<ion-toolbar color=\"primary\">\n\t\t<ion-title>Characters</ion-title>\n\t</ion-toolbar>\n</ion-header>\n\n<ion-content>\n\n\t<ion-list>\n\t\t<!-- Using ngFor for go through all the characters, \n\t\t\tdefining the funtion that will be called for show the details of each character-->\n\t\t<ion-item button detail lines=\"inset\" *ngFor=\"let character of characters\" (click)=\"openDetails(character)\">\n\t\t\t<!-- https://ionicframework.com/docs/api/avatar -->\n\t\t\t<!-- Using a the ion-avatar showing the image of each character -->\n\t\t\t<ion-avatar slot=\"start\">\n\t\t\t\t<img src=\"{{ character.img }}\">\n\t\t\t</ion-avatar>\n\t\t\t<!-- Showing the name of each character -->\n            {{ character.name }}\n\t\t</ion-item>\n\t</ion-list>\n\n\t<!--https://www.youtube.com/watch?v=NBeExE9dvR0 - the code was based on this solution -->\n\t<!--https://ionicframework.com/docs/api/infinite-scroll -->\n\t<!-- The function loadData will load more characters in the characters array -->\n\t<ion-infinite-scroll threshold=\"30%\" (ionInfinite)=\"loadData($event)\">\n\t\t<ion-infinite-scroll-content loading-spinner=\"dots\" loading-text=\"Loading more characters...\">\n\t\t</ion-infinite-scroll-content>\n\t</ion-infinite-scroll>\n</ion-content>";
    /***/
  },
  ...
  function srcAppPagesCharactersCharactersPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharactersPage = /*#__PURE__*/function () {
      function CharactersPage(router, api) {
        ...
        this.router = router;
        this.api = api; //array of characters used to load the data in the html 

        this.characters = []; //offset value is increased in the load data function and starts with 0

        this.offset = 0; //the Breaking bad api has 63 characters, so it is the maximum size of the offset
      ...
      _createClass(CharactersPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.api.getCharactersWithPagination(this.offset).subscribe(function (res) {
        ...
        value: function loadData(event) {
          ...
          this.offset += 10;
          this.api.getCharactersWithPagination(this.offset).subscribe(function (res) {
            _this2.characters = _this2.characters.concat(res);
