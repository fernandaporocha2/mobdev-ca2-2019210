...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["episode-details-episode-details-module"], {
  ...
  function srcAppPagesEpisodeDetailsEpisodeDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_episode_reaction_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./../../services/episode-reaction.service */
    "./src/app/services/episode-reaction.service.ts");

    var EpisodeDetailsPage = /*#__PURE__*/function () {
      function EpisodeDetailsPage(activatedRoute, api, reactionService) {
      ...
      _createClass(EpisodeDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.episodeId = this.activatedRoute.snapshot.paramMap.get('id'); //get and set up the information of the character
          ...
          this.reactionService.isLiked(this.episodeId).then(function (liked) {
            _this.isLiked = liked;
            console.log("liked");
            console.log(JSON.stringify(liked));
          });
          this.reactionService.isDisliked(this.episodeId).then(function (disliked) {
        ...
        value: function likeEpisode() {
          ...
          this.reactionService.likeEpisode(this.episodeId).then(function () {
            _this2.isLiked = true;
        ...
        value: function dislikeEpisode() {
          ...
          // it updates the variables of states of the buttons like and dislike 
          this.reactionService.dislikeEpisode(this.episodeId).then(function () {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _services_episode_reaction_service__WEBPACK_IMPORTED_MODULE_4__["EpisodeReactionService"]])], EpisodeDetailsPage);
    /***/
  },
  ...
  /***/
  function srcAppServicesEpisodeReactionServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EpisodeReactionService", function () {
      return EpisodeReactionService;
    });
    /* harmony import */
    ...
    /*! @ionic/storage */
    "./node_modules/@ionic/storage/fesm2015/ionic-storage.js"); //Constants that will store the liked and disliked episodes keys


    var LIKE_KEY = 'likedEpisodes';
    var DISLIKE_KEY = 'dislikedEpisodes';

    var EpisodeReactionService = /*#__PURE__*/function () {
      function EpisodeReactionService(storage) {
        _classCallCheck(this, EpisodeReactionService);

        this.storage = storage;
      } //It return all the liked episodes


      _createClass(EpisodeReactionService, [{
        key: "getLikedEpisodes",
        value: function getLikedEpisodes() {
        ...
        key: "getDislikedEpisodes",
        value: function getDislikedEpisodes() {
        ...
        key: "isLiked",
        value: function isLiked(episodeId) {
          return this.getLikedEpisodes().then(function (result) {
            console.log("isLiked");
        ...
        key: "isDisliked",
        value: function isDisliked(episodeId) {
          return this.getDislikedEpisodes().then(function (result) {
        ...
        value: function likeEpisode(episodeId) {
          ...
          return this.getLikedEpisodes().then(function (result) {
            if (result) {
              ...
              _this4.storage.set(LIKE_KEY, [episodeId]);
        ...
        value: function dislikeEpisode(episodeId) {
          ...
          this.removeFromLikedEpisode(episodeId); //It gets all the disliked episodes
          ...
          return this.getDislikedEpisodes().then(function (result) {
            if (result) {
              ...
              _this5.storage.set(DISLIKE_KEY, [episodeId]);
        ...
        key: "neutreEpisode",
        value: function neutreEpisode(episodeId) {
          this.removeFromDislikedEpisode(episodeId);
          this.removeFromLikedEpisode(episodeId);
        } //It removes an episodeId from the liked list

      }, {
        key: "removeFromLikedEpisode",
        value: function removeFromLikedEpisode(episodeId) {
          var _this6 = this;
        ...
        key: "removeFromDislikedEpisode",
        value: function removeFromDislikedEpisode(episodeId) {
          var _this7 = this;

          return this.getDislikedEpisodes().then(function (result) {
            console.log(JSON.stringify(result.indexOf(episodeId))); //It verifies if the given characterId is in the disliked list and removes it
    ...
    EpisodeReactionService.ctorParameters = function () {
      return [{
        type: _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]
      }];
    };

    EpisodeReactionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])], EpisodeReactionService);
    /***/
  }
}]);
