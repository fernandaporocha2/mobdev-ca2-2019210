  ...
  function srcAppPagesDeathsDeathsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DeathsPage = /*#__PURE__*/function () {
      function DeathsPage(api) {
        ...
        this.api = api; // this variable stores the text typed byt the user in the searchbar
      ...
      _createClass(DeathsPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {} //This function searches all the responsibles name by deaths that contains the typed text

      }, {
        key: "searchDeathCount",
        value: function searchDeathCount() {
          var _this = this;

          this.api.getDeathCount(this.responsible).subscribe(function (res) {
            _this.death = res[0];
            console.log(_this.death);
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]])], DeathsPage);
    /***/
  }
}]);
